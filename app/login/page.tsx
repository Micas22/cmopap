          ...
          <div className="flex mb-7 bg-gray-100 rounded-2xl p-1 gap-1">
            {(["login", "signup"] as const).map((m) => (
              <button
                ...
                className={`relative flex-1 py-2.5 text-sm font-semibold rounded-xl transition-colors duration-200 z-10 ${mode === m ? "text-gray-800" : "text-gray-400 hover:text-gray-600"
                  }`}
              >
