        ...
        <div className="max-w-[1400px] mx-auto px-6 py-3 flex items-center justify-between gap-4">
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="max-w-[100px] truncate">{email ? email.split("@")[0] : "Admin"}</span>
            </button>
            ...
            <AnimatePresence>
              {showPopup && (
                ...
                >
                  ...
                  <p className="text-gray-800 font-semibold text-sm mb-4 truncate">{email ? email.split("@")[0] : "Guest"}</p>
